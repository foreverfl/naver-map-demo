        ...
        {details ? (
          <>
            ...
            <section className="mb-6">
              <h2 className="text-lg font-semibold mb-4 text-gray-700">모집공고 주요정보</h2>
                  ...
                  <table className="w-full border-collapse table-fixed">
                    <tbody>
                      ...
                      <tr className="border-b border-gray-200">
                        ...
                        <td className="px-4 py-3 text-gray-800">{details.address}</td>
                      </tr>
                      {/* 공급번호 */}
                      <tr className="border-b border-gray-200">
                        <td className="px-4 py-3 font-medium text-gray-600 w-1/4 whitespace-nowrap">
                        ...
                        <td className="px-4 py-3 text-gray-800">{details.houseManageNo}</td>
                      </tr>
                      {/* 문의처 */}
                      <tr>
                        <td className="px-4 py-3 font-medium text-gray-600 w-1/4 whitespace-nowrap">
            ...
            <section className="mb-6">
              ...
              <tr className="border-b">
                ...
                <td className="px-4 py-2">{formatDate(details.rcritpblancde)}</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-2 font-medium">청약접수시작일</td>
                <td className="px-4 py-2">{formatDate(details.subscrptRceptBgnde)}</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-2 font-medium">청약접수종료일</td>
                <td className="px-4 py-2">{formatDate(details.subscrptRceptEndde)}</td>
              </tr>
              <tr>
                <td className="px-4 py-2 font-medium">당첨자 발표일</td>
                <td className="px-4 py-2">{formatDate(details.przwnerPresnatnDe)}</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-2 font-medium">계약 시작일</td>
                <td className="px-4 py-2">{formatDate(details.cntrctCnclsBgnde)}</td>
              </tr>
              <tr>
                <td className="px-4 py-2 font-medium">계약 종료일</td>
                <td className="px-4 py-2">{formatDate(details.cntrctCnclsEndde)}</td>
              </tr>
            </tbody>
