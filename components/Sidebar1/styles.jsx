...
export const styles = {
    ...
    // 헤더 스타일
    header: "bg-blue-100 text-blue-700 p-6 text-lg font-bold rounded-lg shadow-md", 
    ...
    // 테이블 헤더 스타일
    tableHeader: "bg-blue-200 text-left px-4 py-2 font-semibold border border-gray-300",
    ...
    // 버튼 스타일
    button: "bg-blue-500 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-600",
